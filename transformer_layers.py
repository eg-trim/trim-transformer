...
class CumulativeTransformerKV(Module):
    r"""A transformer model using cumulative attention.

    This is a complete transformer implementation that uses cumulative linear attention
    for improved efficiency compared to standard scaled dot product attention.
    ...
    Examples::
        >>> transformer_model = CumulativeTransformerKV(nhead=16, num_encoder_layers=12)
        >>> src = torch.rand((10, 32, 512))
    ...
    def __init__(
        ...
        self.encoder = CumulativeTransformerEncoderKV(
    ...
    def forward(
        ...
        r"""Take in and process masked source sequences.
